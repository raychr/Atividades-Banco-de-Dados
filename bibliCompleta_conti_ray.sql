...
--c) continuação 
INSERT INTO usuarios (cdusuario, cpf)
VALUES (8, '66677788899'), 
       (9, '99988877766'); 

--d) cotinuação
INSERT INTO livros (cdlivro, nmlivro, edicao, genero, ano_publicacao, preco, cdautor, cdeditora)
VALUES (11, 'Livro 11', 1, 'Fiction', 1000, 15.99, 1, 1), 
       (12, 'Livro 12', 1, 'Fiction', 1000, 16.99, 2, 1), 
       (13, 'Livro 13', 1, 'Fiction', 2000, 17.99, 3, 2); 
...
--k) 
SELECT a.cdautor, a.nmautor, l.nmlivro
FROM autores a
JOIN livros l ON a.cdautor = l.cdautor;